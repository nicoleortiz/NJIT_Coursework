...
def litCricFriend(wordList, text):
    ...
    newWordList = [''.join(c for c in s if c not in string.punctuation) for s in text]
    ...
    for i in range(len(wordList)):
        for y in range(len(newWordList)):
            if wordList[i] == newWordList[y]:
                count = count+1
...
words = ['a', 'an']
print("Bells AAN Frequency: " + str(litCricFriend(words, theBells)))
print("CantoXII AAN Frequency: " + str(litCricFriend(words, cantoXII)))
word = ['the']
print("Bells THE Frequency: " + str(litCricFriend(word, theBells)))
print("CantoXII THE Frequency: " + str(litCricFriend(word, cantoXII)))
...
'''
print("\n")
print("Poe uses the words 'a' and 'an' more frequently than Neruda.")
print("Poe also uses the word 'the' more frequently than Neruda.")
